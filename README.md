...
<table style="width: 100%; border-collapse: collapse; text-align: center; border: 1px solid #ccc; table-layout: auto;">
  ...
  <tr>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 40%;">
      <img src="resources/512p/2/image1.jpg" alt="Image 1" style="height: 200px; object-fit: contain;">
    </td>
  ...
  <tr>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 40%;">
      <div style="display: flex; justify-content: center; gap: 10px; align-items: center;">
        <img src="resources/512p/3/image1.jpg" alt="Image 1" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/3/image2.jpg" alt="Image 2" style=" height: 200px; object-fit: contain;">
      </div>
    </td>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 60%;">
  ...
  <tr>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 40%;">
      <div style="display: flex; justify-content: center; gap: 10px; align-items: center;">
        <img src="resources/512p/4/image1.jpg" alt="Image 1" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/4/image2.jpg" alt="Image 2" style=" height: 200px; object-fit: contain;">
      </div>
    </td>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 60%;">
  ...
  <tr>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 40%;">
      <div style="display: flex; justify-content: center; gap: 10px; align-items: center;">
        <img src="resources/512p/5/image1.jpg" alt="Image 1" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/5/image2.jpg" alt="Image 2" style=" height: 200px; object-fit: contain;">
      </div>
    </td>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 60%;">
  ...
  <tr>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 40%;">
      <div style="display: flex; justify-content: center; gap: 10px; align-items: center;">
        <img src="resources/512p/6/image1.jpg" alt="Image 1" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/6/image2.jpg" alt="Image 2" style=" height: 200px; object-fit: contain;">
      </div>
    </td>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 60%;">
  ...
  <tr>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 40%;">
      <div style="display: flex; justify-content: center; gap: 8px; align-items: center; flex-wrap: wrap;">
        <img src="resources/512p/8/image1.jpg" alt="Image 1" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/8/image2.jpg" alt="Image 2" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/8/image3.jpg" alt="Image 3" style=" height: 200px; object-fit: contain;">
      </div>
    </td>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 60%;">
  ...
  <tr>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 40%;">
      <div style="display: flex; justify-content: center; gap: 8px; align-items: center; flex-wrap: wrap;">
        <img src="resources/512p/9/subject_0.png" alt="Image 1" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/9/subject_1.png" alt="Image 2" style=" height: 200px; object-fit: contain;">
        <img src="resources/512p/9/subject_2.png" alt="Image 3" style=" height: 200px; object-fit: contain;">
      </div>
    </td>
    <td style="text-align: center; vertical-align: middle; padding: 10px; width: 60%;">
